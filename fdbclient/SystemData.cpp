...
const KeyRef workloadKeyPrefixesKey = LiteralStringRef("\xff\x02/workloadKeyPrefixesKey");
const KeyRef workloadKeyPrefixesTriggerKey = LiteralStringRef("\xff\x02/workloadKeyPrefixesTrigger");
