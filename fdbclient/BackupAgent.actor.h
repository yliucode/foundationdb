...
public:
	...
	using ParallelRestoreRequest = std::pair<Standalone<VectorRef<KeyRangeRef>>, Version>;
	...
	Future<Void> submitParallelRestore(Database cx, Key backupTag, Standalone<VectorRef<KeyRangeRef>> backupRanges,
	                                   ...
	                                   Key removePrefix);
	Future<Void> submitParallelRestore(Database cx, Key backupTag, std::vector<ParallelRestoreRequest> requests,
